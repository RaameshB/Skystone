...
*/
        ...
        while(!(Math.pow(robot.x - pointTwo.x, 2) + Math.pow(robot.y - pointTwo.y, 2) < 1) && !opMode.isStopRequested() && checkDirection() > 0.08 && checkDirection() < -0.08) {
