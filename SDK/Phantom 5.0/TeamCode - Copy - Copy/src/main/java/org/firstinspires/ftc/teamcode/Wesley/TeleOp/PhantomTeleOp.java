package org.firstinspires.ftc.teamcode.Wesley.TeleOp;
...
/**NEW**/
            ...
            else if((robot.lift.getCurrentPosition() < 640 /*960*/ && -gamepad2.right_stick_y > 0)) {
                lift = -gamepad2.right_stick_y;
            } else if (robot.lift.getCurrentPosition() < 0) {
                lift = 0.2;
            } else if (robot.lift.getCurrentPosition() > 640 /*960*/) {
                lift = -0.2;
            } else {
                lift = 0;
            }
