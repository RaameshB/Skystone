...
public class Config {
    ...
    public DcMotor yEncoder1;
    public DcMotor yEncoder2;
    ...
    public void reverse() {
        ...
        if (frontRight.getDirection() == DcMotorSimple.Direction.REVERSE) {
            frontRight.setDirection(DcMotorSimple.Direction.FORWARD);
        } else {
            frontRight.setDirection(DcMotorSimple.Direction.REVERSE);
        }
        if (backLeft.getDirection() == DcMotorSimple.Direction.REVERSE) {
            backLeft.setDirection(DcMotorSimple.Direction.FORWARD);
        } else {
            backLeft.setDirection(DcMotorSimple.Direction.REVERSE);
        }
        if (backRight.getDirection() == DcMotorSimple.Direction.REVERSE) {
            backRight.setDirection(DcMotorSimple.Direction.FORWARD);
        } else {
            backRight.setDirection(DcMotorSimple.Direction.REVERSE);
        }
