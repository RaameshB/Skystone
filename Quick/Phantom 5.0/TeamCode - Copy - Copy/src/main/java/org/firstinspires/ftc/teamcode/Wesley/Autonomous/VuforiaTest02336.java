...
import org.firstinspires.ftc.teamcode.Wesley.AutoSide.RedAuto;
import org.firstinspires.ftc.teamcode.Wesley.Robot.Drive;
import org.firstinspires.ftc.teamcode.Wesley.Robot.Path;
...
import org.firstinspires.ftc.teamcode.Wesley.Robot.RunPath;
...
@Disabled
@Autonomous(name="be")
public class VuforiaTest02336 extends RedAuto{

    Drive robot = new Drive(this);

    ElapsedTime runtime = new ElapsedTime();

    RunPath runner = new RunPath(robot);
    ...
    @Override public void runOpMode() {
        ...
        while (!isStopRequested() && runtime.seconds() < 5 && notFound) {
            ...
            if (targetVisible) {
                stoneX = lastLocation.getTranslation().get(1)/mmPerInch;
                target.setPoint(stoneX + 12, 18, -45);
                notFound = false;
                telemetry.addData("point x", target.x);
                telemetry.addData("point y", target.y);
                telemetry.update();
            }
        }
        ...
        drive1.addPoint(stoneX+12, 18, -45);
        drive1.addPoint(stoneX, 30, -45);
        ...
        drive2.addPoint(12, 26, -90);
        drive2.addPoint(60, 26, -90);
